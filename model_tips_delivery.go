...
// checks if the TipsDelivery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TipsDelivery{}

// TipsDelivery struct for TipsDelivery
type TipsDelivery struct {
	// 收藏引导文案内容，不得超过14个字
...
// NewTipsDelivery instantiates a new TipsDelivery object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTipsDelivery() *TipsDelivery {
	this := TipsDelivery{}
	return &this
}

// NewTipsDeliveryWithDefaults instantiates a new TipsDelivery object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTipsDeliveryWithDefaults() *TipsDelivery {
	this := TipsDelivery{}
	return &this
}

// GetDeliveryContent returns the DeliveryContent field value if set, zero value otherwise.
func (o *TipsDelivery) GetDeliveryContent() string {
...
func (o *TipsDelivery) GetDeliveryContentOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryContent) {
		return nil, false
	}
...
func (o *TipsDelivery) HasDeliveryContent() bool {
	if o != nil && !IsNil(o.DeliveryContent) {
		return true
	}
...
func (o *TipsDelivery) SetDeliveryContent(v string) {
	o.DeliveryContent = &v
}

// GetDeliveryId returns the DeliveryId field value if set, zero value otherwise.
func (o *TipsDelivery) GetDeliveryId() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetDeliveryIdOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryId) {
		return nil, false
	}
...
func (o *TipsDelivery) HasDeliveryId() bool {
	if o != nil && !IsNil(o.DeliveryId) {
		return true
	}
...
func (o *TipsDelivery) SetDeliveryId(v string) {
	o.DeliveryId = &v
}

// GetDeliveryName returns the DeliveryName field value if set, zero value otherwise.
func (o *TipsDelivery) GetDeliveryName() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetDeliveryNameOk() (*string, bool) {
	if o == nil || IsNil(o.DeliveryName) {
		return nil, false
	}
...
func (o *TipsDelivery) HasDeliveryName() bool {
	if o != nil && !IsNil(o.DeliveryName) {
		return true
	}
...
func (o *TipsDelivery) SetDeliveryName(v string) {
	o.DeliveryName = &v
}

// GetEndTime returns the EndTime field value if set, zero value otherwise.
func (o *TipsDelivery) GetEndTime() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetEndTimeOk() (*string, bool) {
	if o == nil || IsNil(o.EndTime) {
		return nil, false
	}
...
func (o *TipsDelivery) HasEndTime() bool {
	if o != nil && !IsNil(o.EndTime) {
		return true
	}
...
func (o *TipsDelivery) SetEndTime(v string) {
	o.EndTime = &v
}

// GetFailReason returns the FailReason field value if set, zero value otherwise.
func (o *TipsDelivery) GetFailReason() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetFailReasonOk() (*string, bool) {
	if o == nil || IsNil(o.FailReason) {
		return nil, false
	}
...
func (o *TipsDelivery) HasFailReason() bool {
	if o != nil && !IsNil(o.FailReason) {
		return true
	}
...
func (o *TipsDelivery) SetFailReason(v string) {
	o.FailReason = &v
}

// GetMatchType returns the MatchType field value if set, zero value otherwise.
func (o *TipsDelivery) GetMatchType() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetMatchTypeOk() (*string, bool) {
	if o == nil || IsNil(o.MatchType) {
		return nil, false
	}
...
func (o *TipsDelivery) HasMatchType() bool {
	if o != nil && !IsNil(o.MatchType) {
		return true
	}
...
func (o *TipsDelivery) SetMatchType(v string) {
	o.MatchType = &v
}

// GetMatchUrl returns the MatchUrl field value if set, zero value otherwise.
func (o *TipsDelivery) GetMatchUrl() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetMatchUrlOk() (*string, bool) {
	if o == nil || IsNil(o.MatchUrl) {
		return nil, false
	}
...
func (o *TipsDelivery) HasMatchUrl() bool {
	if o != nil && !IsNil(o.MatchUrl) {
		return true
	}
...
func (o *TipsDelivery) SetMatchUrl(v string) {
	o.MatchUrl = &v
}

// GetStartTime returns the StartTime field value if set, zero value otherwise.
func (o *TipsDelivery) GetStartTime() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetStartTimeOk() (*string, bool) {
	if o == nil || IsNil(o.StartTime) {
		return nil, false
	}
...
func (o *TipsDelivery) HasStartTime() bool {
	if o != nil && !IsNil(o.StartTime) {
		return true
	}
...
func (o *TipsDelivery) SetStartTime(v string) {
	o.StartTime = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *TipsDelivery) GetStatus() string {
...
// and a boolean to check if the value has been set.
func (o *TipsDelivery) GetStatusOk() (*string, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *TipsDelivery) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *TipsDelivery) SetStatus(v string) {
	o.Status = &v
}

func (o TipsDelivery) MarshalJSON() ([]byte, error) {
...
func (o TipsDelivery) ToMap() (map[string]interface{}, error) {
...
type NullableTipsDelivery struct {
	value *TipsDelivery
	isSet bool
}

func (v NullableTipsDelivery) Get() *TipsDelivery {
	return v.value
}

func (v *NullableTipsDelivery) Set(val *TipsDelivery) {
	v.value = val
	v.isSet = true
}

func (v NullableTipsDelivery) IsSet() bool {
	return v.isSet
}

func (v *NullableTipsDelivery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTipsDelivery(val *TipsDelivery) *NullableTipsDelivery {
	return &NullableTipsDelivery{value: val, isSet: true}
}

func (v NullableTipsDelivery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTipsDelivery) UnmarshalJSON(src []byte) error {
	v.isSet = true
