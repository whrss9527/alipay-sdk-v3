...
func (o *Role) GetCcsInstanceId() string {
...
func (o *Role) GetCcsInstanceIdOk() (*string, bool) {
	if o == nil || IsNil(o.CcsInstanceId) {
		return nil, false
	}
...
func (o *Role) HasCcsInstanceId() bool {
	if o != nil && !IsNil(o.CcsInstanceId) {
		return true
	}
...
func (o *Role) SetCcsInstanceId(v string) {
	o.CcsInstanceId = &v
}

// GetCreateTime returns the CreateTime field value if set, zero value otherwise.
func (o *Role) GetCreateTime() string {
...
// and a boolean to check if the value has been set.
func (o *Role) GetCreateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.CreateTime) {
		return nil, false
	}
...
func (o *Role) HasCreateTime() bool {
	if o != nil && !IsNil(o.CreateTime) {
		return true
	}
...
func (o *Role) SetCreateTime(v string) {
	o.CreateTime = &v
}

// GetCreatorId returns the CreatorId field value if set, zero value otherwise.
func (o *Role) GetCreatorId() string {
...
// and a boolean to check if the value has been set.
func (o *Role) GetCreatorIdOk() (*string, bool) {
	if o == nil || IsNil(o.CreatorId) {
		return nil, false
	}
...
func (o *Role) SetCreatorId(v string) {
	o.CreatorId = &v
}
...
func (o *Role) GetFunctionIds() []string {
...
// and a boolean to check if the value has been set.
func (o *Role) GetFunctionIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.FunctionIds) {
		return nil, false
	}
...
func (o *Role) HasFunctionIds() bool {
	if o != nil && !IsNil(o.FunctionIds) {
		return true
	}
...
func (o *Role) SetFunctionIds(v []string) {
	o.FunctionIds = v
}
...
func (o *Role) GetUpdateTime() string {
...
// and a boolean to check if the value has been set.
func (o *Role) GetUpdateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o *Role) HasUpdateTime() bool {
	if o != nil && !IsNil(o.UpdateTime) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *Role) GetUpdaterIdOk() (*string, bool) {
	if o == nil || IsNil(o.UpdaterId) {
		return nil, false
	}
...
func (o *Role) SetUpdaterId(v string) {
	o.UpdaterId = &v
}
