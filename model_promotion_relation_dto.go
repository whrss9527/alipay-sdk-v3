...
// checks if the PromotionRelationDTO type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PromotionRelationDTO{}

// PromotionRelationDTO struct for PromotionRelationDTO
type PromotionRelationDTO struct {
	// 申请推广时填写的申请理由
...
// NewPromotionRelationDTO instantiates a new PromotionRelationDTO object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPromotionRelationDTO() *PromotionRelationDTO {
	this := PromotionRelationDTO{}
	return &this
}

// NewPromotionRelationDTOWithDefaults instantiates a new PromotionRelationDTO object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPromotionRelationDTOWithDefaults() *PromotionRelationDTO {
	this := PromotionRelationDTO{}
	return &this
}

// GetApplyReason returns the ApplyReason field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetApplyReason() string {
...
func (o *PromotionRelationDTO) GetApplyReasonOk() (*string, bool) {
	if o == nil || IsNil(o.ApplyReason) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasApplyReason() bool {
	if o != nil && !IsNil(o.ApplyReason) {
		return true
	}
...
func (o *PromotionRelationDTO) SetApplyReason(v string) {
	o.ApplyReason = &v
}

// GetCommodityId returns the CommodityId field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetCommodityId() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetCommodityIdOk() (*string, bool) {
	if o == nil || IsNil(o.CommodityId) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasCommodityId() bool {
	if o != nil && !IsNil(o.CommodityId) {
		return true
	}
...
func (o *PromotionRelationDTO) SetCommodityId(v string) {
	o.CommodityId = &v
}

// GetCommodityName returns the CommodityName field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetCommodityName() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetCommodityNameOk() (*string, bool) {
	if o == nil || IsNil(o.CommodityName) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasCommodityName() bool {
	if o != nil && !IsNil(o.CommodityName) {
		return true
	}
...
func (o *PromotionRelationDTO) SetCommodityName(v string) {
	o.CommodityName = &v
}

// GetCreateTime returns the CreateTime field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetCreateTime() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetCreateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.CreateTime) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasCreateTime() bool {
	if o != nil && !IsNil(o.CreateTime) {
		return true
	}
...
func (o *PromotionRelationDTO) SetCreateTime(v string) {
	o.CreateTime = &v
}

// GetPromoterContactName returns the PromoterContactName field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetPromoterContactName() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromoterContactNameOk() (*string, bool) {
	if o == nil || IsNil(o.PromoterContactName) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromoterContactName() bool {
	if o != nil && !IsNil(o.PromoterContactName) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromoterContactPhoneOk() (*string, bool) {
	if o == nil || IsNil(o.PromoterContactPhone) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromoterContactPhone() bool {
	if o != nil && !IsNil(o.PromoterContactPhone) {
		return true
	}
...
func (o *PromotionRelationDTO) SetPromoterContactPhone(v string) {
	o.PromoterContactPhone = &v
}

// GetPromoterName returns the PromoterName field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetPromoterName() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromoterNameOk() (*string, bool) {
	if o == nil || IsNil(o.PromoterName) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromoterName() bool {
	if o != nil && !IsNil(o.PromoterName) {
		return true
	}
...
func (o *PromotionRelationDTO) SetPromoterName(v string) {
	o.PromoterName = &v
}

// GetPromoterPid returns the PromoterPid field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetPromoterPid() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromoterPidOk() (*string, bool) {
	if o == nil || IsNil(o.PromoterPid) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromoterPid() bool {
	if o != nil && !IsNil(o.PromoterPid) {
		return true
	}
...
func (o *PromotionRelationDTO) SetPromoterPid(v string) {
	o.PromoterPid = &v
}

// GetPromotionId returns the PromotionId field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetPromotionId() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromotionIdOk() (*string, bool) {
	if o == nil || IsNil(o.PromotionId) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromotionId() bool {
	if o != nil && !IsNil(o.PromotionId) {
		return true
	}
...
func (o *PromotionRelationDTO) SetPromotionId(v string) {
	o.PromotionId = &v
}

// GetPromotionName returns the PromotionName field value if set, zero value otherwise.
func (o *PromotionRelationDTO) GetPromotionName() string {
...
// and a boolean to check if the value has been set.
func (o *PromotionRelationDTO) GetPromotionNameOk() (*string, bool) {
	if o == nil || IsNil(o.PromotionName) {
		return nil, false
	}
...
func (o *PromotionRelationDTO) HasPromotionName() bool {
	if o != nil && !IsNil(o.PromotionName) {
		return true
	}
...
func (o *PromotionRelationDTO) SetPromotionName(v string) {
	o.PromotionName = &v
}

func (o PromotionRelationDTO) MarshalJSON() ([]byte, error) {
...
func (o PromotionRelationDTO) ToMap() (map[string]interface{}, error) {
...
type NullablePromotionRelationDTO struct {
	value *PromotionRelationDTO
	isSet bool
}

func (v NullablePromotionRelationDTO) Get() *PromotionRelationDTO {
	return v.value
}

func (v *NullablePromotionRelationDTO) Set(val *PromotionRelationDTO) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotionRelationDTO) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotionRelationDTO) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotionRelationDTO(val *PromotionRelationDTO) *NullablePromotionRelationDTO {
	return &NullablePromotionRelationDTO{value: val, isSet: true}
}

func (v NullablePromotionRelationDTO) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotionRelationDTO) UnmarshalJSON(src []byte) error {
	v.isSet = true
